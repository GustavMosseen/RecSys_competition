...
def read_data_split_and_search2(data_path, output_folder_path):
    """
    This function provides a simple example on how to tune parameters of a given algorithm
    Input:
        -
    ...
    dl_URM = dl.URM.tocsr()
    URM_train, URM_validation, URM_test = dl.split_the_dataset(dl_URM, 0.8, 3)  # 80, 10, 10
    '''
    from Data_manager.Movielens.Movielens1MReader import Movielens1MReader
    from Data_manager.DataSplitter_Holdout import DataSplitter_Holdout
...
if __name__ == '__main__':
    ...
    output_folder = "result_experiments/SKOPT_test/"

    read_data_split_and_search2(data_path, output_folder)
